...
<a class="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-brand-700 focus:text-white focus:px-4 focus:py-2" href="#contenido">
...
<header class="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-line">
	<nav class="container-fd flex items-center justify-between py-3" aria-label="<?php esc_attr_e( 'Navegación principal', 'flowdesk' ); ?>">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center gap-2 font-heading font-semibold text-lg text-ink-900 no-underline">

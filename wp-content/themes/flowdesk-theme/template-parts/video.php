...
<section id="video" class="container-fd py-20">
	...
	<div class="fd-card p-3 max-w-3xl mx-auto">
		<div
		...
		>
			...
			<span class="absolute inset-0 flex items-center justify-center">
				<span class="w-16 h-16 rounded-full bg-brand-700 group-hover:bg-brand-900 flex items-center justify-center transition-colors">
					<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" class="text-white ml-1" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg>
				</span>
			</span>
		</div>
	</div>

...
<section class="relative container-fd py-20 sm:py-28 text-center overflow-hidden">
	<div class="pointer-events-none absolute inset-0 -z-10 flex justify-center" aria-hidden="true">
		<div class="w-[36rem] h-[36rem] rounded-full bg-gradient-to-br from-brand-100 via-accent/10 to-transparent blur-3xl opacity-70 -translate-y-24 animate-pulse [animation-duration:8s]"></div>
	</div>
	...
	<p class="mt-6 text-base text-ink-400 max-w-2xl mx-auto fd-reveal">
